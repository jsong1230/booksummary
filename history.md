...
2. **수요 측 지표를 만들 것** — 지금 우리는 공급(경쟁 영상 조회수)만 재고 수요는 안 잰다.
   경쟁이 낮은 이유가 "공급이 적어서"인지 "아무도 안 찾아서"인지 못 가른다.
   Google Trends / 네이버 데이터랩 검색량 연동이 후보 (사용자 승인 대기)
3. 다음 편 후보는 `data/candidates.md` — 원미동 사람들(2,099) · 이중나선(752) ·
   당신들의 천국(817) · 논 이야기(1,037) · 미스터 방(4,497)
4. **선정 기준 판독은 12월 초** (새 기준 9편이 9/07~10/02 공개 → +90일)
