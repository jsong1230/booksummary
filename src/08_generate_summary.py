...
**매우 중요: 반드시 실제 책의 내용을 기반으로 작성하세요.**
- 작가의 실제 작품 내용을 정확히 반영해야 합니다
- 작가의 다른 작품이나 일반적인 주제와 혼동하지 마세요
- 책의 실제 줄거리, 등장인물, 주요 사건을 정확히 요약하세요
- 불확실한 내용은 추측하지 말고, 알려진 사실만 사용하세요
- 나무위키(https://namu.wiki/w/작별인사)나 신뢰할 수 있는 출처의 정보를 참고하세요

**참고 정보:**
- '작별인사'는 김영하 작가의 2022년작 장편 SF 소설입니다
- 상세 서기 2100년대를 배경으로 합니다
- SF 장르의 작품이므로 미래 배경과 SF적 요소를 반영해야 합니다
"""
