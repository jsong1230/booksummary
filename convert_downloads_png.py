...
def main():
    ...
    for png_file in png_files:
        ...
        # 언어 구분
        if '_en' in filename_lower or 'english' in filename_lower or 'en' in filename_lower:
            # 영어용으로 추정
            output_path = output_dir / f"{clean_stem}_thumbnail_en.jpg"
        elif '_ko' in filename_lower or '_kr' in filename_lower or 'korean' in filename_lower or '한글' in filename_lower:
            # 한글용으로 추정
