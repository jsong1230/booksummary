...
if [ -f "/Users/jsong/go/bin/moai" ]; then
	exec "/Users/jsong/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/jsong/.local/bin/moai" ]; then
	exec "/Users/jsong/.local/bin/moai" statusline < "$temp_file"
fi
